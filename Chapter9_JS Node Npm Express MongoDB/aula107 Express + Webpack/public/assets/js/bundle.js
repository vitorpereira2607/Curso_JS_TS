...
input:focus {
  ...
  border-radius: 0.5rem;
}`, "",{"version":3,"sources":["webpack://./frontend/assets/css/style.css"],"names":[],"mappings":"AAEA;EACE,wBAAwB;EACxB,0EAA0E;AAC5E;;AAEA;EACE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,SAAS;EACT,UAAU;EACV,sCAAsC;AACxC;;AAEA;EACE,iBAAiB;EACjB,eAAe;EACf,QAAQ;EACR,SAAS;EACT,gCAAgC;EAChC,qBAAqB;EACrB,aAAa;EACb,yBAAyB;EACzB,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,UAAU;AACZ;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,YAAY;AACd;;AAEA;EACE,oBAAoB;EACpB,WAAW;EACX,2BAA2B;AAC7B;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,gBAAgB;EAChB,yBAAyB;EACzB,eAAe;EACf,qBAAqB;EACrB,yBAAyB;AAC3B;;AAEA;EACE,4BAA4B;AAC9B;;AAEA;EACE,8BAA8B;EAC9B,qBAAqB;AACvB","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n\n:root {\n  --primary-color: #f95959;\n  --shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background-color: var(--primary-color);\n}\n\n.container {\n  background: white;\n  position: fixed;\n  top: 30%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  border-radius: 0.5rem;\n  padding: 10px;\n  box-shadow: var(--shadow);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 30%;\n}\n\n.content-section h1 {\n  text-align: center;\n  width: 100%;\n  height: 100%;\n}\n\nform {\n  display: inline-grid;\n  width: 100%;\n  padding: 0px 10px 10px 10px;\n}\n\nlabel {\n  text-align: start;\n}\n\nbutton {\n  margin-top: 30px;\n  background-color: #e3e3e3;\n  cursor: pointer;\n  border-radius: 0.5rem;\n  box-shadow: var(--shadow);\n}\n\nbutton:hover {\n  background-color: aquamarine;\n}\n\ninput:focus {\n  outline-color: 120px solid red;\n  border-radius: 0.5rem;\n}"],"sourceRoot":""}]);
// Exports
